...
layui.use(['layer', 'form', 'admin', 'laydate', 'ax'], function () {
    ...
    //获取菜单信息
    var ajax = new $ax(Feng.ctxPath + "/tMenuIndex/getMenuInfo?menuId=" + Feng.getUrlParam("menuId"));
    ...
    $('#pcodeName').click(function () {
        ...
        var treeUrl = encodeURIComponent("/tMenuIndex/selectMenuTreeList");
    ...
    form.on('submit(btnSubmit)', function (data) {
        var ajax = new $ax(Feng.ctxPath + "/tMenuIndex/edit", function (data) {
            Feng.success("修改成功！");
