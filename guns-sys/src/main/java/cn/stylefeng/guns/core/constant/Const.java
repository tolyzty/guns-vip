...
public interface Const {
     ...
     * 不需要权限验证的资源表达式
     */
    List<String> NONE_PERMISSION_RES = CollectionUtil.newLinkedList("/assets/**", "/gunsApi/**", "/admin/login","/admin/**",
            "/global/sessionError", "/kaptcha", "/error", "/global/error","/Balls/**/**","/index.html");
