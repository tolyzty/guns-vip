...
public class ConstantFactory implements IConstantFactory {
    ...
    public String getNewType(String newType) {
        return NewsEnum.NewsType.getDescription(newType);
    }

    @Override
    public String getTopStatus(String topStatus) {
        return CommentEnum.TopStatus.getDescription(topStatus);
    }

    @Override
    public String getCommentType(String commentType) {
        return CommentEnum.CommentType.getDescription(commentType);
    }

    @Override
    public String getCommentStatus(String commentStatus) {
