 ...
 */
public class TmenuIndexWrapper extends BaseControllerWrapper {

    public TmenuIndexWrapper(Map<String, Object> single) {
        super(single);
    }

    public TmenuIndexWrapper(List<Map<String, Object>> multi) {
        super(multi);
    }

    public TmenuIndexWrapper(Page<Map<String, Object>> page) {
        super(page);
    }

    public TmenuIndexWrapper(PageResult<Map<String, Object>> pageResult) {
        super(pageResult);
    }
